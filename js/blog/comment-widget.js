...
const s_daylightSavings = false; // If your personal timezone uses DST, set this to truec
...
const s_filteredWords = [ // Add words to filter by putting them in quotes and separating with commas (ie. 'heck', 'dang')
    'heck', 'dang', 'faggot', 'whore', 'dyke', 'retard', 'nigger', 'nigga', 'fag', 'lolicon', 'shota', 'shotacon', 'nazi', 'nazism', 'hitler', 'rape',
    'shemale', 'trannie', 'tranny', 'zoophilia', 'zoophile', 'pedophile', 'pedophilia', 'futanari', 'incest'
]
